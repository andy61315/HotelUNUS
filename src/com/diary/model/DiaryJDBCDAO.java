...
public class DiaryJDBCDAO implements DiaryDAO_interface {
	...
	private static final String INSERT_STMT = 
			...
			+ "VALUES ('DI'||LPAD(to_char(diary_no_seq.NEXTVAL),6,'0'), ?, SYSDATE, ?, ?, ?)";
		...
		private static final String DELETE = 
			"UPDATE Diary SET STATUS = 0 WHERE diary_no = ?";
		private static final String UPDATE = 
			"UPDATE Diary set diary_title=?, diary_content=?, diary_status=? where diary_no = ?";
		//查詢熱門日誌
		...
		"SELECT * FROM Diary WHERE diary_title LIKE '%' || ? || '%' AND diary_status = 2 ";
		//查詢我的日誌
...
//			pstmt.setDate(2, diaryVO.getDiary_date());
			pstmt.setString(3, diaryVO.getDiary_title());
			pstmt.setString(4, diaryVO.getDiary_content());
			pstmt.setInt(5, diaryVO.getDiary_status());
			pstmt.setString(6, diaryVO.getDiary_no());
...
//		Set<DiaryMessageVO> set = new LinkedHashSet<DiaryMessageVO>();
...
//			pstmt = con.prepareStatement(GET_Message_ByDiary_no_STMT);
...
//				}
	...
	public static void main(String[] args) {
		...
		dao.getLatestDiaries();
		
//		Set<DiaryMessageVO> qwe = dao.getMessageBydiaryno("DI000002");
//		qwe.forEach(System.out::println);
		 //新增
...
//
//		// 顯示列表
//		List<DiaryVO> list = dao.getAll();
//		for (DiaryVO diaryVO4 : list) {
//			System.out.print(diaryVO4.getDiary_no() + ",");
//			System.out.print(diaryVO4.getCus_id() + ",");
//			System.out.print(diaryVO4.getDiary_date() + ",");
//			System.out.print(diaryVO4.getDiary_title() + ",");
//			System.out.print(diaryVO4.getDiary_content() + ",");
//			System.out.println(diaryVO4.getDiary_status() + ",");
//			System.out.println("---------------------");
//			System.out.println();
//		}
