...
<body>
	...
	<div class="container">
		...
		<form method="post" action="meal.do" enctype="multipart/form-data">
			<div class="row">
				<!-- 左側 -->
				<div class="col-md-4">
				圖片欄位
				  ...
				  資料欄位
					<div class="row">
						<table>
							...
							<tr>
								<td>餐點名稱:</td>
								<td><input type="text" name="meal_name" value="${mealVO.meal_name}"/></td>
							</tr>
							<tr>
								<td>價格:</td>
								<td><input type="text" name="price" value="${mealVO.price}" /></td>
							</tr>
							<!-- 要做 useBean + forEach -->
							...
							<tr>
								<td>修改日期:</td>
								<td><input type="date" name="meal_date" value="${mealVO.meal_date}"/></td>
							</tr>
							<tr>
								<td>餐點介紹:</td>
								<td><textarea cols="20" rows="4" name="meal_introduction">${mealVO.meal_introduction}</textarea></td>
							</tr>
						</table>
					</div>
				</div>
