		...
		$(document).ready(function(){
			...
			$('#demo').bootstrapTable({
			  columns:[ // 欄位設定
			    ...
			    {field:'meal_no', title:'雇員編號', align:'center', width:120, visible:true, sortable:true},
			    {field:'mealImgTag', title:'雇員圖片', align:'center', width:80, visible:true},
			    {field:'meal_name', title:'emp_name', align:'center', width:120, visible:true, sortable:true},
			    {field:'price', title:'emp_phone', align:'center', width:200, visible:true},
			    {field:'res_no', title:'emp_email', align:'center', width:200, visible:true},
			    {field:'meal_type_no', title:'emp_password', align:'center', width:200, visible:true},
			    {field:'meal_date', title:'emp_status', align:'center', width:100, visible:true, sortable:true},
			    {field:'meal_status', title:'emp_status', align:'center', width:100, visible:true, sortable:true},
			    {field:'meal_introduction', title:'emp_status', align:'center', width:100, visible:true, sortable:true},
			  ],
			  data : [],
