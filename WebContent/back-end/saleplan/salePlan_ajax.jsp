		...
		$(document).ready(function(){
			...
			$('#demo').bootstrapTable({
			  columns:[ // 欄位設定
			    ...
			    {field:'sapl_no', title:'專案編號', align:'center', width:120, visible:true, sortable:true},
			    {field:'sapl_name', title:'專案名稱', align:'left', visible:true, sortable:true},
			    {field:'detail', title:'專案內容', align:'left', width:200, visible:true},
			    {field:'start_date', title:'開始時間', align:'left', width:200, visible:true},
			    {field:'end_date', title:'結束時間', align:'left', width:200, visible:true},
			    {field:'sapl_discount', title:'優惠折扣', align:'left', width:200, visible:true},
			    {field:'status', title:'專案狀態', align:'left', width:200, visible:true}
			  ],
			  data : [],
			...
			// step 2. 開始從後端撈資料（第一次）
			param = {action: 'getData', pageNo: '1', pageSize: '10', orderBy: 'sapl_no', orderType: 'asc', like: ''};
			loadData(param);
