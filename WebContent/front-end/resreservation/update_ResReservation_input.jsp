...
<%
    ResReservationVO resrVO = (ResReservationVO) request.getAttribute("resrVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>預約資料修改 - update_reservationNo_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>預約資料修改 - update_reservationNo_input.jsp</h3>
...
<FORM METHOD="post" ACTION="resr.do" name="form1">
<table>
	<tr>
	...
	<tr>
		<td>預約時段:</td>
		<td><input type="TEXT" name="resvPeriod" size="45"	value="<%=resrVO.getResvPeriod()%>" /></td>
	</tr>
	<tr>
		<td>預約人數:</td>
		<td><input type="TEXT" name="resvPeople" size="45" value="<%=resrVO.getResvPeople()%>" /></td>
	</tr>
