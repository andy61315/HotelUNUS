...
<!-- Templatemo style -->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/front-end/css/multipleDropup.css">
<!-- Templatemo style -->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/listMyDiary.css">
...
<body>
	...
	<div class="row justify-content-center align-items-center p-3"
		style="font-family: 'Noto Bold', sans-serif">
		<div id='codingHere'
			style="width: 98vw; height: 1000px; margin: 10px 5px; border: 5px solid black">
			...
			<%@ include file="page1.file"%>
				<c:forEach var="DiaryVO" items="${diaryList}" begin="0" end="3">
					<div class="card mb-3"
						style="max-width: 100%; border-radius: 35px; overflow: hidden">
									...
									<div class="row h-100">
										...
										<div class="col-12 title">
											<a
												...
												<h2 class="card-title">${DiaryVO.diary_title}</h2>
											</a>
										</div>
										...
										<div class="col-12 text-right my-auto" style="font-size: 14px">
											<span class="text-muted ml-2">發表於<fmt:formatDate
													type="date" value="${DiaryVO.diary_date}" /></span>
